...
common/Thirdparty/SEGGER/Segger/SEGGER_RTT_ASM_ARMv7M.o: E:/FreeRTOS_V11/RTOS_workspace/common/Thirdparty/SEGGER/Segger/SEGGER_RTT_ASM_ARMv7M.S common/Thirdparty/SEGGER/Segger/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m4 -g3 -DDEBUG -c -I"E:/FreeRTOS_V11/RTOS_workspace/common/Thirdparty/SEGGER/Config" -I"E:/FreeRTOS_V11/RTOS_workspace/common/Thirdparty/SEGGER/Segger" -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@" "$<"
